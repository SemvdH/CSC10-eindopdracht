...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../vga_image_viewer_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is vga_image_viewer_system
SOPC_NAME := vga_image_viewer_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x41010
SOPC_SYSID_FLAG += --sidp=0x41010
ELF_PATCH_FLAG  += --sidp 0x41010

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1674404482
SOPC_SYSID_FLAG += --timestamp=1674404482
ELF_PATCH_FLAG  += --timestamp 1674404482
